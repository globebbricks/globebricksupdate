...
class BuyPropertySearching extends StatefulWidget {
  final List<String> propertyFilter;
  final double radius;


  const BuyPropertySearching({super.key, required this.propertyFilter, required this.radius});

  @override
  State<BuyPropertySearching> createState() => _BuyPropertySearchingState();
}

class _BuyPropertySearchingState extends State<BuyPropertySearching> with SingleTickerProviderStateMixin {
  ...
  Widget _body() {
    ...
    FirebaseFirestore.instance.collection('property').doc("buy").collection("data");
    ...
    GeoCollectionReference<Map<String, dynamic>>(collectionReference)
        .subscribeWithin(
        center: center,
        radiusInKm: widget.radius,
        field: field,
        geopointFrom: geopointFrom,
        queryBuilder: (query) => query
            .where('isVisible', isEqualTo: true)
            .where("category", whereIn: widget.propertyFilter),strictMode: true);
    return loading
        ? Center(
        child: SizedBox(
