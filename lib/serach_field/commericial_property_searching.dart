...
class CommericialPropertySearching extends StatefulWidget {
  final List<String> propertyFilter;
  final double radius;

  const CommericialPropertySearching({super.key, required this.propertyFilter, required this.radius});

  @override
  State<CommericialPropertySearching> createState() => _CommericialPropertySearchingState();
}

class _CommericialPropertySearchingState extends State<CommericialPropertySearching>  with SingleTickerProviderStateMixin {
