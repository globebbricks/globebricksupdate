...
class FlatmatesSearching extends StatefulWidget {
  final List<String> propertyFilter;
  final double radius;
  const FlatmatesSearching({super.key, required this.propertyFilter, required this.radius});

  @override
  State<FlatmatesSearching> createState() => _FlatmatesSearchingState();
}

class _FlatmatesSearchingState extends State<FlatmatesSearching>
...
Widget _body() {
  ...
  FirebaseFirestore.instance.collection('property').doc("pg").collection("data");
